...
from basicsr_local.metrics.metric_util import reorder_image, to_y_channel
...
def calculate_nrmse(img, img2, crop_border, input_order='HWC', test_y_channel=False, **kwargs):
